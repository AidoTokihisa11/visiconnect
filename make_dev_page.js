  ...
  return (
    <PageWrapper>
      ...
      <HeroSection>
        ...
        <CodeShowcase>
          <MacHeader>
            <div className="dots"><div className="red"/><div className="yellow"/><div className="green"/></div>
      ...
      <Section>
        <APIGrid>
          <div>
            <h3 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '1rem' }}>Une API REST puissante</h3>
            <p style={{ color: '#475569', fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem' }}>Gérez les salles, les utilisateurs et l'analytics de manière programmatique via notre API documentée (OpenAPI).</p>
