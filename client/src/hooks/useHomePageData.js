...
export const useHomePageData = () => {
  ...
  const sliderData = [
    { 
      ...
      description: "Contrôlez vos réunions en un clic.", 
      color: "#3b82f6" 
    },
    { 
      title: "Mode Studio", 
      description: "Qualité 4K sans compromis.", 
      color: "#8b5cf6" 
    },
    { 
      title: "Analytiques", 
      description: "Suivez l'engagement en temps réel.", 
      color: "#10b981" 
    },
  ];
  ...
  const featuresData = [
    {
      ...
      items: t('homeFeatures.video.items', [
        'Jusqu\'à 1080p en HD',
        'Codec optimisé VP9',
        'Adaptative bitrate'
      ]) || [],
    ...
    },
    {
      ...
      items: t('homeFeatures.security.items', [
        'Chiffrement E2E',
        'Conformité RGPD',
    ...
    },
    {
      ...
      items: t('homeFeatures.instant.items', [
        'URL partageable',
        'Accès immédiat',
        'Sans inscription'
      ]) || [],
    ...
    },
    {
      ...
      items: t('homeFeatures.collaboration.items', [
        'Partage d\'écran HD',
        'Chat intégré',
