...
const deTranslations = {
  ...
  features: {
    ...
    videoCall: {
      ...
      description:
        "Kristallklare Videoqualität bis zu 4K mit Studio-Audioqualität",
    },
    screenShare: {
      title: "Bildschirmfreigabe",
      description:
        "Teilen Sie Ihren Bildschirm, Anwendungen oder spezifische Tabs",
    },
    recording: {
      title: "Aufzeichnung",
      description:
        "Nehmen Sie Ihre Meetings auf und greifen Sie später darauf zu",
    },
    chat: {
    ...
    whiteboard: {
      title: "Whiteboard",
      description:
        "Kollaborieren Sie visuell mit einem integrierten Whiteboard",
    },
    security: {
  ...
  encryptionDesc:
    "Alle Ihre Kommunikationen sind durch militärische AES-256-Verschlüsselung geschützt.",
  secureInfrastructure: "Sichere Infrastruktur",
  infrastructureDesc:
    "Unsere Server sind in zertifizierten Rechenzentren mit maximaler physischer Sicherheit gehostet.",
  ...
  visionText:
    "VisioConnect entstand aus meiner Leidenschaft für moderne Kommunikationstechnologien. Als Full-Stack-Entwickler wollte ich eine Lösung schaffen, die technologische Innovation und außergewöhnliche Benutzererfahrung kombiniert.",
  technicalStack: "Technischer Stack",
  stackText:
    "React.js, WebRTC, Socket.io, Node.js, MongoDB, AI/ML für Videooptimierung und viele andere cutting-edge Technologien für eine reibungslose Erfahrung.",
  ...
  integrations: {
    ...
    google: {
      description:
        "Integrieren Sie Gmail, Google Calendar, Drive und die gesamte Google Suite für maximale Produktivität.",
    },
    microsoft: {
      description:
        "Synchronisieren Sie Teams, Outlook, OneDrive und SharePoint für optimale Zusammenarbeit.",
    },
    slack: {
      description:
        "Verbinden Sie Slack, um Benachrichtigungen zu erhalten und Ihre Meetings aus Ihrem Workspace zu steuern.",
    },
    zoom: {
      description:
        "Native Integration mit Zoom für eine reibungslose Video-Erfahrung und erweiterte Funktionen.",
    },
    trello: {
      description:
        "Verwalten Sie Ihre Projekte und Aufgaben direkt aus Ihren Meetings mit bidirektionaler Synchronisation.",
    },
    jira: {
      description:
        "Synchronisieren Sie Ihre Projekte und Dokumentation für optimales Team-Management.",
    },
    salesforce: {
      description:
        "Integrieren Sie Ihr CRM, um Interessenten und Kunden direkt in Meetings zu verfolgen.",
    },
    github: {
      description:
