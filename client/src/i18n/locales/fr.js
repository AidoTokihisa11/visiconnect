const frTranslations = {
  ...
  homeFeatures: {
    ...
    video: {
      ...
      items: ["Support jusqu'à 4k", 'Suppression du bruit AI', 'Codec VP9 / AV1'],
    },
    security: {
    ...
    collaboration: {
      ...
      items: ["Partage d'écran", 'Tableau blanc collaboratif', 'Chat en temps réel'],
    },
    meetings: {
      title: 'Réunions instantanées',
  ...
  developmentStatus: 'Plateforme en production',
  ...
  personalDescription:
    "Salut ! Moi c'est Théo, j'ai 25 ans et je développe VisioConnect depuis juillet 2023. C'est ma plateforme de visioconférence faite avec React et Node.js. Le projet est en production depuis 2024.",
  keyStats: {
    teams: 'Équipes ',
    native: 'App Native',
    latency: 'Latence Moy.',
