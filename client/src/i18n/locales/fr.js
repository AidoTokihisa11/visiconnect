...
const frTranslations = {
  ...
  features: {
    ...
    videoCall: {
      ...
      description:
        "Qualité vidéo cristalline jusqu'à 4K avec audio de qualité studio",
    },
    screenShare: {
      title: "Partage d'écran",
      description:
        "Partagez votre écran, des applications ou des onglets spécifiques",
    },
    recording: {
  ...
  myVision: "Ma vision",
  visionDescription:
    "Démocratiser l'accès à des outils de communication professionnels de haute qualité. Chaque équipe, quelle que soit sa taille, mérite une technologie qui amplifie sa collaboration.",
  technologiesUsed: "Technologies",
  techDescription:
    "React.js, WebRTC, Supabase Realtime, Node.js, AI/ML pour l'optimisation vidéo, et bien d'autres technologies cutting-edge pour une expérience fluide.",
  ...
  integrations: {
    ...
    google: {
      description:
        "Intégrez Gmail, Google Calendar, Drive et toute la suite Google pour une productivité maximale.",
    },
    microsoft: {
      description:
        "Synchronisez Teams, Outlook, OneDrive et SharePoint pour une collaboration optimale.",
    },
    slack: {
      description:
        "Connectez Slack pour recevoir des notifications et contrôler vos réunions depuis votre workspace.",
    },
    zoom: {
      description:
        "Intégration native avec Zoom pour une expérience vidéo fluide et des fonctionnalités étendues.",
    },
    trello: {
      description:
        "Gérez vos projets et tâches directement depuis vos réunions avec une synchronisation bidirectionnelle.",
    },
    jira: {
      description:
        "Synchronisez vos projets et documentations pour une gestion optimale des équipes.",
    },
    salesforce: {
      description:
        "Intégrez votre CRM pour suivre vos prospects et clients directement en réunion.",
    },
    github: {
      description:
  ...
  encryptionDesc:
    "Toutes vos communications sont protégées par un chiffrement AES-256 de niveau militaire.",
  secureInfrastructure: "Infrastructure sécurisée",
  infrastructureDesc:
    "Nos serveurs sont hébergés dans des centres de données certifiés avec une sécurité physique maximale.",
  ...
  featuresCarousel: {
    slide1: {
      ...
      description:
        "Une qualité 4K ultra-fluide qui capture chaque nuance. Notre moteur de rendu s'adapte automatiquement à votre bande passante pour garantir zéro coupure.",
    ...
    slide2: {
      ...
      description:
        "Suivez l'engagement, la qualité des appels et l'utilisation des salles en temps réel. Des graphiques clairs pour comprendre l'activité de votre entreprise.",
    ...
    slide3: {
      ...
      description:
        "Une application mobile native qui rivalise avec la version desktop. Rejoignez une réunion en un tap, partagez votre écran et chattez sans compromis.",
      tag: "Mobilité Totale",
    },
  },
  ui: {
