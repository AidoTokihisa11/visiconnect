const ruTranslations = {
  ...
  testimonials: {
    ...
    subtitle: 'Компании всех размеров используют нашу платформу для эффективного сотрудничества.',
    items: {
      1: {
        content: 'Качество 4K просто безумное. Вы действительно чувствуете себя в одной комнате!',
        name: 'Мари Дюбуа',
        role: 'Основатель TechStart',
      },
      2: {
        content: 'Идеально подходит для наших удаленных разработчиков. Очень плавно!',
        name: 'Жан Мартин',
        role: 'CTO',
      },
      3: {
        content: 'Нет аналогов на рынке за эту цену. Профессиональное качество, действительно.',
        name: 'Софи Леклерк',
  ...
  homeFeatures: {
    ...
    security: {
      ...
      items: ['Сквозное шифрование E2E', 'Совместимость с RGPD', 'Никакие данные не хранятся'],
    },
    meetings: {
      ...
      items: ['Ссылки в 1 клик', 'Аккаунт не требуется', 'Совместимость с мобильными устройствами'],
    },
    collaboration: {
      ...
      items: ['Демонстрация экрана', 'Совместная доска', 'Чат в реальном времени'],
    },
    title: 'Все для успешных встреч',
    subtitle: 'Мощные функции для современных команд. Безопасно, надежно и просто.',
  },
  architecture: {
  ...
  footer: {
    ...
    optimizedFor: 'Оптимизировано для чистой производительности, а не для масс.',
    product: 'Продукт',
    company: 'О нас',
    legal: 'Правовая информация',
  },
