const ruTranslations = {
  ...
  featuresCarousel: {
    slide1: {
      ...
      subtitle:
        "Почувствуйте присутствие вашей команды, где бы вы ни находились.",
      description:
        "Сверхплавное качество 4K, которое фиксирует каждый нюанс. Наш движок автоматически адаптируется к вашей пропускной способности, гарантируя отсутствие сбоев.",
      tag: "Визуальный опыт",
    },
    slide2: {
      title: "Аналитическая панель",
      subtitle: "Точные данные для быстрых решений.",
      description:
        "Отслеживайте вовлеченность, качество звонков и использование комнат в реальном времени.",
      tag: "Бизнес-аналитика",
    },
    slide3: {
      title: "Доступно везде",
      subtitle: "От офиса до кафе без проблем.",
      description:
        "Нативное мобильное приложение, которое конкурирует с десктопной версией. Присоединяйтесь в один клик.",
      tag: "Полная мобильность",
    },
  },
  ui: {
    plus: "5",
