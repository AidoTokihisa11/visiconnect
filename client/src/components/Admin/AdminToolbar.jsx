    ...
    <>
      ...
      >
        <NavGroup>
          ...
          <IconButton $active={isLiveEdit} onClick={toggleLiveEdit} title="Toggle Live Edit Mode">
            <Pencil size={18} />
          </IconButton>
        </NavGroup>
          ...
          <>
            ...
            >
              ...
              <ConfigSection>
                ...
                <label className="block text-sm text-slate-400 mb-2 mt-4">
              ...
              <ConfigSection>
                ...
                <ColorPicker>
                  {['#2563eb', '#10b981', '#ef4444', '#f59e0b', '#8b5cf6', '#ec4899'].map(
                    (color) => (
                      <ColorDot
                        key={color}
                        color={color}
