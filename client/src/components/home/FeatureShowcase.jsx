...
const MeetingView = () => (
  <div
    style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', gap: '1rem' }}
  >
...
const AnalyticsView = () => (
  ...
  >
    {[1, 2, 3].map((i) => (
      ...
      >
        <div style={{ fontSize: '0.875rem', color: COLORS.secondary, marginBottom: '0.5rem' }}>
          Metric {i}
        </div>
