    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span
            className="absolute -top-1 -right-1 text-xs bg-primary text-primary-foreground rounded-full w-4 h-4 flex items-center justify-center font-semibold uppercase"
            style={{ zIndex: 10 }}
          >
            {language.slice(0, 2)}
          </span>
