                ...
                <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-green-400 h-64 overflow-y-auto">
                  {logs.map((log) => (
                    <div key={log.id} className="mb-2 border-b border-slate-800 pb-2 last:border-0">
                      ...
                      <span className={log.status === 'error' ? 'text-red-400' : 'text-blue-400'}>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <p className="text-sm text-yellow-700 mb-4">
                  Gérez les données stockées localement sur ce navigateur. Effacer le cache vous
                  déconnectera.
                </p>
                <button
                  onClick={clearCache}
  ...
  if (loading)
    return (
      ...
      >
        ...
        <span style={{ marginLeft: '1rem', fontSize: '1.2rem', color: '#64748b' }}>
