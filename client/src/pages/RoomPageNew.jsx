                  ...
                  {regenStatus !== 'sent' ? (
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-[13px] text-green-700 font-semibold">Code envoyé ! Vérifiez votre boîte mail.</p>
                      </div>
                      <p className="text-[11px] text-green-600 mt-1.5 ml-6">La réception peut prendre jusqu'à <strong>5 minutes</strong>. Ne renvoyez pas plusieurs fois, vérifiez également vos spams.</p>
                    </div>
                  )}
