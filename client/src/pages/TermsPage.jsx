  ...
  return (
    <LegalLayout title={t('termsOfUse')} lastUpdated="21 Février 2024">
      ...
      <Paragraph>
        ...
        de la confidentialité de votre compte et de votre mot de passe, ainsi que de toutes les
        activités qui se produisent sous votre compte.
      </Paragraph>

      <SectionTitle>3. Utilisation Acceptable</SectionTitle>
      <Paragraph>Vous acceptez de ne pas :</Paragraph>
      <List>
      ...
      <Paragraph>
        Nous pouvons résilier ou suspendre votre accès immédiatement, sans préavis ni
        responsabilité, pour quelque raison que ce soit, y compris, sans s'y limiter, si vous
        enfreignez les Conditions.
      </Paragraph>
