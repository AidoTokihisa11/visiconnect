 ...
 * Used everywhere we surface a Stripe-originated error to avoid the
 * generic "carte non valide" fallback that confused beta-testers.
 *
...
const FR_MESSAGES = {
  // Card errors
  expired_card: "Votre carte a expiré. Utilisez une autre carte ou mettez à jour sa date d'expiration.",
  card_declined: "Votre carte a été refusée par votre banque. Contactez-la ou essayez une autre carte.",
  ...
  api_connection_error: "Connexion au service de paiement impossible. Vérifiez votre connexion internet.",
  api_error: "Erreur du service de paiement. Veuillez réessayer plus tard.",
  // Default
  _default: "Le paiement n'a pas pu être finalisé. Vérifiez vos informations ou essayez une autre carte.",
};
