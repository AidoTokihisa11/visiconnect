...
export class AIImageEnhancer {
  constructor() {
    ...
    this.sharpnessIntensity = 1.10;  // Intensité du sharpening adaptatif
  ...
  processFrame = () => {
    ...
    if (this.canvas.width !== this.videoElement.videoWidth) {
      ...
      this.detectedResolution = Math.min(this.videoElement.videoWidth, this.videoElement.videoHeight);
    }
